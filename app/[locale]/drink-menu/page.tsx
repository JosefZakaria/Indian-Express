...
import { DRINK_MENU_SECTIONS } from '@/lib/menus/drink-menu-data';

export default async function DrinkMenuPage({
  params,
}: {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      {DRINK_MENU_SECTIONS.map((section, index) => {
        const sectionNote = tOptional(dict, `drinkMenu.sections.${section.id}.note`);
        return (
          <Fragment key={section.id}>
            <section className="mb-0 scroll-reveal" data-scroll-reveal>
            ...
            {index < DRINK_MENU_SECTIONS.length - 1 ? (
              <div
